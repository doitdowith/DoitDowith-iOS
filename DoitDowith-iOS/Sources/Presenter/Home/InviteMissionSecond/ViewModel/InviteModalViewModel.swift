...
final class InviteModalViewModel: InviteModalViewModelInput,
  ...
  init(memberId: Int) {
    ...
    let friends = BehaviorRelay<[Friend]>(value: [Friend(id: 2, url: url[0], state: .success, name: "이예림"),
                                                  Friend(id: 3, url: url[1], state: .fail, name: "박재영"),
                                                  Friend(id: 4, url: url[2], state: .success, name: "조구영"),
                                                  Friend(id: 5, url: url[4], state: .success, name: "김영균"),
                                                  Friend(id: 6, url: url[5], state: .success, name: "해범이"),
